...
def part2(boxes, strings):
    for string in strings:
        ...
        if string.find('-') >= 0:
            ...
            operation = '='
            fl = int(string.split(operation)[1])
...
print(f'Solution 1: {sumHashes(strings)}')
print(f'Solution 2: {part2([{}]*256, strings)}')
